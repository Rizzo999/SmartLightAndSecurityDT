...
import smartobject.resource.mqtt.ContactSensorResource;
import smartobject.resource.mqtt.PresenceSensorResource;
import smartobject.resource.mqtt.ResourceDataListener;
import smartobject.resource.mqtt.SmartObjectResource;
...
public class PresenceMonitoringSmartObject {
    ...
    private static final String PRESENCE_SENSOR_TOPIC = "presence";

    private static final String CONTACT_SENSOR_TOPIC = "contact";
